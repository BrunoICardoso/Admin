    ...
    public class Processos_Seae
    {
        ...
        public string resumo
        {
            ...
            get
            {
                ...
                return Resumo == null ? Resumo =null : Resumo.Replace("\n", "<br>");
            }
        ...
        public string comoparticipar
        {
            get
            {
                return Comoparticipar==null ? Comoparticipar = null : Comoparticipar.Replace("\n", "<br>");
            }
            set
            {
        ...
        public string premios
        {
            get
            {
                return Premios == null ? Premios = null : Premios.Replace("\n", "<br>");
            }
            set
            {
                Premios = value;
