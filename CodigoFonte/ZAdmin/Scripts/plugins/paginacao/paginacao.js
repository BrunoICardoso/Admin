...
function Paginacao() {
    ...
    this.CriaPaginacao = function (seletor, totalPaginas, totalRegistros, paginaAtual) {
        ...
        //$(seletor).append(newUl);

        SelecionaPagina();

        //$(seletor).find(".pagina").click(function () {
        ...
        //$(seletor).find(".btnnext").click(function () {
        ...
        //$(seletor).find(".btnprev").click(function () {
